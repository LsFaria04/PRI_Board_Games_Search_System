# Query solr and convert results to trec format (uses existing query files from half script)
...
# Remove-Item output\results_trec.txt -ErrorAction SilentlyContinue
